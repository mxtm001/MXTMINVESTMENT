...
export default function AdminDashboard() {
  ...
  const handleApproveTransaction = (userEmail: string, transactionId: string) => {
    updateTransactionStatus(userEmail, transactionId, "completed")
  ...
  const handleRejectTransaction = (userEmail: string, transactionId: string) => {
    updateTransactionStatus(userEmail, transactionId, "rejected")
  ...
  const handleBlockUser = (email: string) => {
    updateUserStatus(email, "blocked")
                                      ...
                                      {deposit.status === "pending" && (
                                        <div className="flex space-x-2">
                                          <Button
                                            ...
                                            size="sm"
                                            className="h-8 px-2 py-0 bg-green-500/10 hover:bg-green-500/20 text-green-500 border-green-500/20"
                                            onClick={() => handleApproveTransaction(deposit.userEmail, deposit.id)}
                                          >
                                            Approve
                                          </Button>
                                          <Button
                                            ...
                                            size="sm"
                                            className="h-8 px-2 py-0 bg-red-500/10 hover:bg-red-500/20 text-red-500 border-red-500/20"
                                            onClick={() => handleRejectTransaction(deposit.userEmail, deposit.id)}
                                          >
                                            Reject
                                          </Button>
                                        </div>
                                      ...
                                      {withdrawal.status === "pending" && (
                                        <div className="flex space-x-2">
                                          <Button
                                            ...
                                            className="h-8 px-2 py-0 bg-green-500/10 hover:bg-green-500/20 text-green-500 border-green-500/20"
                                            onClick={() =>
                                              handleApproveTransaction(withdrawal.userEmail, withdrawal.id)
                                            }
                                          >
                                            Approve
                                          </Button>
                                          <Button
                                            ...
                                            size="sm"
                                            className="h-8 px-2 py-0 bg-red-500/10 hover:bg-red-500/20 text-red-500 border-red-500/20"
                                            onClick={() => handleRejectTransaction(withdrawal.userEmail, withdrawal.id)}
                                          >
                                            Reject
                                          </Button>
                                        </div>
